...
test('areAllShipsSunk should be able to report whether or not all of ships have been sunk.', () => {
  const gameboard1 = new Gameboard()
  // Create ships
  gameboard1.placeShip(2, 'A', '1', 'H')
  gameboard1.placeShip(2, 'A', '2', 'H')
  ...
  // Create ships
  gameboard2.placeShip(2, 'A', '1', 'H')
  gameboard2.placeShip(2, 'A', '2', 'H')
